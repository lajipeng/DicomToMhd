...
PathDicom = "./051_YE JIN SHENG_2661199_20180529_028Y_M/YE JIN SHENG_2661199_20180529_028Y_M_000/"		#与python文件同一个目录下的文件夹,存储dicom文件

SaveRawDicom = "./Research/Rawfiles"     # 与python文件同一个目录下的文件夹,用来存储mhd文件和raw文件
...
for filenameDCM in lstFilesDCM:
	...
	sys.exit(0)
	#mhd = ArrayDicom[:, :, lstFilesDCM.index(filenameDCM)]
	#print(mhd[1,1])
